...
import { X, MapPin, SlidersHorizontal, RefreshCcw } from 'lucide-react';
...
export default function FilterModal({
  ...
  onUpdateFilters,
  onResetFilters
}: FilterModalProps): React.ReactElement | null {
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-933">تصفية النتائج والخيارات</h2>
          </div>
